    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50 h-14">
        <div className="h-full px-4 flex items-center justify-between">
          <button
            onClick={() =>
              onCategoryChange ? onCategoryChange("all") : setLocation("/")
            }
      ...
      <div
        style={{ display: "flex", minHeight: "calc(100vh - 3.5rem - 57px)" }}
      >
        <aside
          style={{ width: "220px", flexShrink: 0 }}
          className="border-r border-gray-200 bg-white px-3 py-6 flex flex-col"
        >
          ...
          {user ? (
            ...
            <div className="px-2 space-y-3">
              <p className="text-xs text-gray-500">
                Log in to browse and post on Campus Board.
              </p>
            </div>
          )}
